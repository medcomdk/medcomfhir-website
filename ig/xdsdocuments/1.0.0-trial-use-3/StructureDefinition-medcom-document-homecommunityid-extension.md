# MedCom Document HomeCommunityID - Danish XDS Documents profiles v1.0.0-trial-use-3
...
| | |
| :--- | :--- |
| *Official URL*:http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-homecommunityid-extension | *Version*:1.0.0-trial-use-3 |
| Draft as of 2026-07-30 | *Computable Name*:MedComDocumentHomeCommunityID |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/medcom.fhir.dk.xdsdocuments|current/StructureDefinition/StructureDefinition-medcom-document-homecommunityid-extension.json)
