...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile DkCoreMinimalDocumentReference
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference">
      ...
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-homecommunityid-extension']) &lt;= 1">extension with URL = 'http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-homecommunityid-extension': maximum cardinality of 'extension' is 1</sch:assert>
