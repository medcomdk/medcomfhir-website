# MedComContainedDocumentReference - Danish XDS Documents profiles v1.0.0-trial-use-3
...
| | |
| :--- | :--- |
| *Official URL*:http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-contained-documentreference | *Version*:1.0.0-trial-use-3 |
| Draft as of 2026-07-30 | *Computable Name*:MedComContainedDocumentReference |
...
* Derived from this Profile: [HomeCareObservationDocumentReference](StructureDefinition-homecare-observation-documentreference.md) and [MedComConditionListDocumentReference](StructureDefinition-medcom-conditionlist-documentreference.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/medcom.fhir.dk.xdsdocuments|current/StructureDefinition/StructureDefinition-medcom-contained-documentreference.json)
...
```json
{
  ...
  "url" : "http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-contained-documentreference",
  "version" : "1.0.0-trial-use-3",
  "name" : "MedComContainedDocumentReference",
  "status" : "draft",
  "date" : "2026-07-30T12:29:31+00:00",
  "publisher" : "MedCom",
  "contact" : [{
    "name" : "MedCom",
    "telecom" : [{
  ...
  "baseDefinition" : "http://hl7.dk/fhir/core/StructureDefinition/dk-core-minimaldocumentreference|3.6.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-homecommunityid-extension"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-homeCommunityId-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-contained-documentreference"
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-typecode-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-classcode-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-patient"],
    ...
    },
    {
      ...
      "slicing" : {
        ...
        "description" : "Authors are sliced by the concrete resource type of the contained author resource.\nThe person-prefixed slices collectively represent the conceptual person author.",
        "rules" : "open"
      },
      "short" : "[DocumentEntry.author] The author:institution slice ensures one mandatory\norganizational author. All remaining author slices represent an optional\nperson, role, patient, or device author.",
      "comment" : "The conceptual person author is represented by separate technical slices\nbecause each type-discriminator slice must resolve to exactly one resource type.",
      "max" : "2",
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-organization",
        "http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-practitionerrole",
        ...
        "http://hl7.dk/fhir/core/StructureDefinition/dk-core-related-person|3.6.0",
    ...
    {
      "id" : "DocumentReference.author:personPractitionerRole",
      "path" : "DocumentReference.author",
      "sliceName" : "personPractitionerRole",
      "short" : "A person/role/patient/device author of the document.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-practitionerrole"],
        "aggregation" : ["contained"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "DocumentReference.author:personPractitioner",
      "path" : "DocumentReference.author",
      "sliceName" : "personPractitioner",
      "short" : "A person/role/patient/device author of the document.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-practitioner"],
        "aggregation" : ["contained"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "DocumentReference.author:personPatient",
      "path" : "DocumentReference.author",
      "sliceName" : "personPatient",
      "short" : "A person/role/patient/device author of the document.",
      "min" : 0,
      "max" : "1",
      "type" : [{
    ...
    {
      "id" : "DocumentReference.author:personRelatedPerson",
      "path" : "DocumentReference.author",
      "sliceName" : "personRelatedPerson",
      "short" : "A person/role/patient/device author of the document.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-related-person|3.6.0"],
        "aggregation" : ["contained"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "DocumentReference.author:personDevice",
      "path" : "DocumentReference.author",
      "sliceName" : "personDevice",
      "short" : "A person/role/patient/device author of the document.",
      "min" : 0,
      "max" : "1",
      "type" : [{
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-practitioner|3.6.0",
        "http://hl7.dk/fhir/core/StructureDefinition/dk-core-practitioner-role|3.6.0",
        "http://hl7.dk/fhir/core/StructureDefinition/dk-core-organization|3.6.0"],
        "aggregation" : ["contained"]
      }],
      "mustSupport" : true
    },
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-mimetype-fhir-VS"
      }
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-languagecode-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-formatcode-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-eventcodelist-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-ihe-core-HealthcareFacilityTypeCode-VS"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-ihe-core-PracticeSettingCode-VS"
      }
    },
    {
