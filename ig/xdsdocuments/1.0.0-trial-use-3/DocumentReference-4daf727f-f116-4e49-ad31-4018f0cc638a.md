# DocumentReference instance - Danish XDS Documents profiles v1.0.0-trial-use-3
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-conditionlist-documentreference"]
  },
  "contained" : [{
