# MedComContainedDocumentReference - Danish XDS Documents profiles v1.0.0-trial-use-1
...
| | |
| :--- | :--- |
| *Official URL*:http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-contained-documentreference | *Version*:1.0.0-trial-use-1 |
| Draft as of 2026-06-01 | *Computable Name*:MedComContainedDocumentReference |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/medcom.fhir.dk.xdsdocuments|current/StructureDefinition/medcom-contained-documentreference)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-06-01T09:33:45+00:00",
  "publisher" : "MedCom",
  "contact" : [
    {
      "name" : "MedCom",
  ...
  "differential" : {
    "element" : [
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://medcomfhir.dk/ig/xdsdocuments/StructureDefinition/medcom-document-homecommunityid-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
              "http://hl7.dk/fhir/core/StructureDefinition/dk-core-practitioner|3.6.0",
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://medcomfhir.dk/ig/xdsdocuments/ValueSet/MedCom-xds-HealthcareFacilityTypeCode-VS-local"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://medcomfhir.dk/ig/xdsdocuments/ValueSet/MedCom-xds-PracticeSettingCode-VS-local"
        }
      },
      {
