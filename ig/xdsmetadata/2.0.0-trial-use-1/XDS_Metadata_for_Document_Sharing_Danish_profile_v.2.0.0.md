# XDS Metadata for Document Sharing Danish Profile v 2 0 0 - Danish profile of the IHE XDS Metadata Standard v2.0.0-trial-use-1

* [**Table of Contents**](toc.md)
* **XDS Metadata for Document Sharing Danish Profile v 2 0 0**
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#authorinstitution)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#authorinstitution)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#authorinstitution)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#authorperson)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#authorperson)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#authorperson)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#availabilitystatus)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#classcode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#classcode)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#confidentialitycode)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#confidentialitycode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#confidentialitycode)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#creationtime)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#creationtime)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#creationtime)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#entryuuid)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#eventcodelist)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#eventcodelist)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#eventcodelist)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#formatcode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#formatcode)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#healthcarefacilitytypecode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#healthcarefacilitytypecode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#homecommunityid)
...
[Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#intendedrecipient)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#languagecode)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#languagecode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#languagecode)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#legalauthenticator)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#legalauthenticator)
...
**ebXML example** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#legalauthenticator)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#mimetype)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#mimetype)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#objecttype)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#practicesettingcode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#practicesettingcode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#referenceidlist)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#repositoryuniqueid)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#servicestarttime)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#servicestarttime)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#servicestoptime)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#servicestoptime)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#servicestoptime)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#size)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#sourcepatientid)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#sourcepatientid)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#sourcepatientid)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#sourcepatientinfo)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#sourcepatientinfo)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#sourcepatientinfo)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#submissiontime)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#title)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#title)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#title)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#typecode)

**CDA Reference:** [Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#typecode)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#typecode)
...
**FHIR Reference:** [Link to FHIR Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_fhir.md#uniqueid)

**CDA Reference:** [Link to CDA Reference][Link to CDA Reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_cda.md#uniqueid)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#uniqueid)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#submissionsetuniqueid)
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#uri)
...
Web: DK-IHE_Metadata-Common_Code_systems-Value_sets [4](#fn:4)
...
The value set for healthcare facility type code represents the allowed values for the type of organizational setting of the clinical encounter during which the documented act occurred. The value set "DK_IHE_HealthcareFacilityTypeCodeSystem" was initially a subset of the code list from the SOR lookup table "SOR-Enhedstyper". All code values are given in the code system SNOMED CT identifiers (SCTID). Further use of code systems are documented in DK-IHE_Metadata-Common_Code_systems-Value_sets [4](#fn:4)
...
The value set for practiceSettingCode represents the type of clinical setting of the clinical encounter during which the documented act occurred. The value set "DK_IHE_practiceSettingCode" was initially comprised of a subset of the code list from the SOR lookup table "clinical_speciality". All code values are SNOMED CT identifiers (SCTID). Further use of code systems are documented in DK-IHE_Metadata-Common_Code_systems-Value_sets [4](#fn:4)
...
1. [DK-IHE_Metadata-Common_Code_systems-Value_sets (opens in new window)](https://svn.medcom.dk/svn/releases/Standarder/IHE/OID/DK-IHE_Metadata-Common_Code_systems-Value_sets.xlsx) [↩](#fnref:4) [↩2](#fnref:4:1) [↩3](#fnref:4:2) [↩4](#fnref:4:3) [↩5](#fnref:4:4) [↩6](#fnref:4:5)
