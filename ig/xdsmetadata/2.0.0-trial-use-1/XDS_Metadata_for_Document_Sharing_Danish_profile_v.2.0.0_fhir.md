# XDS Metadata for Document Sharing Danish Profile v 2 0 0 Fhir - Danish profile of the IHE XDS Metadata Standard v2.0.0-trial-use-1

* [**Table of Contents**](toc.md)
* **XDS Metadata for Document Sharing Danish Profile v 2 0 0 Fhir**
...
**ebXML example:** [Link to ebXML example](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#)
...
**RDK reference:** [Link to RDK reference](XDS_Metadata_for_Document_Sharing_Danish_profile_v.2.0.0_ebxml.md#)
