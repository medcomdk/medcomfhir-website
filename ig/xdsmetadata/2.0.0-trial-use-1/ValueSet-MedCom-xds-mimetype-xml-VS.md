# DK XDS MimeType for non-FHIR XML documents - Danish profile of the IHE XDS Metadata Standard v2.0.0-trial-use-1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DK XDS MimeType for non-FHIR XML documents**

## ValueSet: DK XDS MimeType for non-FHIR XML documents 

| | |
| :--- | :--- |
| *Official URL*:http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-xds-mimetype-xml-VS | *Version*:1.0.0 |
| Active as of 2015-01-04 | *Computable Name*:MedCom_XDS_MimeType_XML |
