# PractitionerRole with a role and reference to a practitioner - DK MedCom Carecommunication v5.0.3
...
**practitioner**: [Practitioner Michael Burns ](Practitioner-5d37f9e1-2beb-4528-81bf-d521d108c738.md)
...
```json
{
  ...
  "id" : "e0aca758-487a-4536-b750-35753cbef090",
  "meta" : {
    "profile" : [
