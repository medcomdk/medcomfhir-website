# 5th message - Instance of Communication resource used in a reply message. - DK MedCom Carecommunication v5.0.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **5th message - Instance of Communication resource used in a reply message.**

## Example Communication: 5th message - Instance of Communication resource used in a reply message.

Profile: [MedComCareCommunication](StructureDefinition-medcom-careCommunication-communication.md)

**identifier**: urn:uuid:546b19ba-3e50-4da8-b9ec-7caeefad6928
...
> **payload****DateTimeExtension**: 2024-05-04 10:00:00+0200**IdentifierExtension**: urn:uuid:bc9382ba-30f7-4020-a7c4-cbd18f9b4115**PractitionerExtension**: [PractitionerRole Sygeplejerske](PractitionerRole-8bf63050-5504-11ed-bdc3-0242ac120002.md)**ContactExtension**: ph: 44527000**content**: Hej - Jeg håber det er okay, at jeg videresender denne forespørgsel. Kan I hjælpe os med at finde den, af Michael Burns, efterspurgte information. På forhånd tak. /Emma

> **payload****DateTimeExtension**: 2024-05-05 11:35:00+0200**IdentifierExtension**: urn:uuid:ffed9804-35e3-449f-a1c3-0f8ece783dc7**content**: null @ https://medcom.dk/projekter/korrespondancemeddelelse/

> **payload****DateTimeExtension**: 2024-05-05 11:35:00+0200**IdentifierExtension**: urn:uuid:76b064ff-e8b0-433f-8b23-780f181dae54**PractitionerExtension**: [PractitionerRole ](PractitionerRole-8adda490-63ef-4d97-86f0-14553628e53a.md)**ContactExtension**: ph: 48456523**content**: Hej Emma, Jeg har vedhæftet linket til siden, med den ønskede information. Mvh. Ann Marie, Visitator.
...
```json
{
  ...
  "id" : "d148fa55-3201-4a18-a7b0-bce67bf597a6",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      "value" : "urn:uuid:546b19ba-3e50-4da8-b9ec-7caeefad6928"
    }
  ],
  "status" : "unknown",
  "category" : [
  ...
  "payload" : [
    ...
    },
    {
      "extension" : [
        {
          "url" : "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-datetime-extension",
          "valueDateTime" : "2024-05-04T10:00:00+02:00"
        },
        {
          "url" : "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-identifier-extension",
          "valueIdentifier" : {
            "value" : "urn:uuid:bc9382ba-30f7-4020-a7c4-cbd18f9b4115",
            "assigner" : {
              "reference" : "Organization/f20f31cd-5dd2-4a80-ab00-97f7109864a7"
            }
          }
      ...
      "contentString" : "Hej - Jeg håber det er okay, at jeg videresender denne forespørgsel. Kan I hjælpe os med at finde den, af Michael Burns, efterspurgte information. På forhånd tak. /Emma"
    },
    {
      "extension" : [
        {
          "url" : "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-datetime-extension",
          "valueDateTime" : "2024-05-05T11:35:00+02:00"
        },
        {
          "url" : "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-identifier-extension",
          "valueIdentifier" : {
            "value" : "urn:uuid:ffed9804-35e3-449f-a1c3-0f8ece783dc7",
            "assigner" : {
      ...
      "contentAttachment" : {
        "url" : "https://medcom.dk/projekter/korrespondancemeddelelse/",
        "title" : "Link"
      }
    },
    {
      "extension" : [
        ...
        },
        {
          "url" : "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-identifier-extension",
          "valueIdentifier" : {
            "value" : "urn:uuid:76b064ff-e8b0-433f-8b23-780f181dae54",
            "assigner" : {
              "reference" : "Organization/f98ed410-54fe-11ed-bdc3-0242ac120002"
            }
          }
      ...
      "contentString" : "Hej Emma, Jeg har vedhæftet linket til siden, med den ønskede information. Mvh. Ann Marie, Visitator."
    }
  ]
}
