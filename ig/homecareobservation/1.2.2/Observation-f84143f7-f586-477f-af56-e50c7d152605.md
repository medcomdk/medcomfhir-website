# Neutrophilocytes observation - MedCom HomeCareObservation v1.2.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Neutrophilocytes observation**

## Example Observation: Neutrophilocytes observation

Profile: [MedComHomeCareObservation](StructureDefinition-medcom-homecare-observation.md)

**status**: Final

**code**: B—Neutrophilocytter; antalk. = ? × 10^9/L
...
**effective**: 2023-09-12 10:34:08+0200
...
```json
{
  ...
  "id" : "f84143f7-f586-477f-af56-e50c7d152605",
  "meta" : {
    "profile" : [
    ...
    "coding" : [
      {
        ...
        "code" : "NPU02902",
        "display" : "B—Neutrophilocytter; antalk. = ? × 10^9/L"
      }
    ]
  },
  "subject" : {
