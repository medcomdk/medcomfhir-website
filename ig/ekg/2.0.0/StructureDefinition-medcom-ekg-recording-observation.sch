...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile MedComDocumentObservation
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/ig/core/StructureDefinition/medcom-observation-value-attachment-extension']) &gt;= 1">extension with URL = 'http://medcomfhir.dk/ig/core/StructureDefinition/medcom-observation-value-attachment-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/ig/core/StructureDefinition/medcom-observation-value-attachment-extension']) &lt;= 1">extension with URL = 'http://medcomfhir.dk/ig/core/StructureDefinition/medcom-observation-value-attachment-extension': maximum cardinality of 'extension' is 1</sch:assert>
