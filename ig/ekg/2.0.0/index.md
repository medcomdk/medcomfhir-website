...
| | |
| :--- | :--- |
| *Official URL*:http://medcomfhir.dk/ig/ekg/ImplementationGuide/medcom.fhir.dk.ekg | *Version*:2.0.0 |
| Active as of 2026-06-04 | *Computable Name*:DKMedComEKG |
...
```json
{
  ...
  "title" : "DK MedCom EKG",
  "status" : "active",
  "date" : "2026-06-04T11:18:05+00:00",
  "publisher" : "MedCom",
  "contact" : [
    {
      "name" : "MedCom",
  ...
  "description" : "The DK MedCom IG for EKG",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://medcomfhir.dk/ig/ekg/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "Bundle/0a74554f-ded3-4bc7-bef1-535699565c5a"
        },
        "name" : "Bundle instance",
        "description" : "Bundle instance",
        "exampleCanonical" : "http://medcomfhir.dk/ig/ekg/StructureDefinition/medcom-ekg-recording-bundle"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "Composition/384ca229-c562-4a26-a035-c0c38108e036"
        },
        "name" : "Elektrokardiogram-12-aflednings",
        "description" : "Composition example for EKG",
        "exampleCanonical" : "http://medcomfhir.dk/ig/ekg/StructureDefinition/medcom-ekg-recording-composition"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "StructureDefinition/medcom-ekg-recording-bundle"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/medcom-ekg-recording-composition"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/medcom-ekg-recording-observation"
        },
      ...
      },
      {
        ...
        "exampleCanonical" : "http://medcomfhir.dk/ig/ekg/StructureDefinition/medcom-ekg-recording-observation"
      },
      {
        "extension" : [
          {
